...
public class MainController {
    ...
    private void handleButtonAction(MouseEvent event) {
    	if(event.getSource() == btn_exit) {
    		...
    		if(event.getSource() == playlistMenu && pane_playlistMenu.isVisible() == false) {
        		pane_playlistMenu.setVisible(true);
        	}
    		else 
    			if(event.getSource() == playlistMenu && pane_playlistMenu.isVisible() == true)
    ...
    /*private void chageMusic() {
    	nowPlaying.setText((new Date()).toString());
    }*/
